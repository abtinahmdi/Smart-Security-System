...
Dynamic Visual Indicators: A dedicated array of Green (Armed status), Blue (Night Mode active), and Red (Alarm triggered) LEDs provides immediate at-a-glance telemetry.
